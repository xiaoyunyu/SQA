...
python convert.py ${ROOTDIR}/RawData/SimpleQuestions_v2/freebase-subsets/freebase-FB5M.txt########将KB库中的主体、关系、目标三元组构造成三个字典：实体、关系、三元组字典
...
echo "create Vocabs"
cd ${ROOTDIR}/vocab
th create_vocab.lua ######将实体、关系字典转化成t7文件
