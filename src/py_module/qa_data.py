...
class QAData(object):
    ...
    def add_sub_score(self,score):
        self.cand_sub_score=[]
        self.cand_sub_score.extend(score)

    def add_sub_text(self,text):
        if not hasattr(self, 'sub_texts'):
            self.sub_texts = []
        self.sub_texts.append(text)

    def set_strict_flag(self,flag):
        self.strict_flag = flag